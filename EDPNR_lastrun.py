...
expName = 'Robyn_PsychoPy_Negative_Music'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jackcrosby/Documents/Robyn_PsychoPy/EDPNR_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('EDP_EXCEL_3.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('EDP_EXCEL_2.xlsx'),
...
slider_3.reset()
# keep track of which components have finished
Mood_Slider_3Components = [slider_3, text_13, image_5, image_6]
for thisComponent in Mood_Slider_3Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
Mood_Slider_3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "Mood_Slider_3"-------
while continueRoutine:
    # get current time
    t = Mood_Slider_3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=Mood_Slider_3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
key_resp_6.rt = []
_key_resp_6_allKeys = []
sound_1.setSound('NegativeMusic.mp3', hamming=True)
...
slider_4.reset()
# keep track of which components have finished
Mood_Slider_4Components = [slider_4, text_14, image_7, image_8]
for thisComponent in Mood_Slider_4Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
Mood_Slider_4Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "Mood_Slider_4"-------
while continueRoutine:
    # get current time
    t = Mood_Slider_4Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=Mood_Slider_4Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
