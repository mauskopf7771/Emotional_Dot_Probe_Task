...
let expName = 'EDPPR';  // from the Builder filename that created this script
...
function Mood_SliderRoutineBegin(snapshot) {
  return async function () {
    ...
    Mood_SliderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instructions_Experiment_InstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    Instructions_Experiment_InstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Test_ResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    Test_ResponseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Mood_Slider_3RoutineBegin(snapshot) {
  return async function () {
    ...
    Mood_Slider_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instructions_MusicRoutineBegin(snapshot) {
  return async function () {
    ...
    Instructions_MusicComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Music_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Music_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Mood_Slider_4RoutineBegin(snapshot) {
  return async function () {
    ...
    Mood_Slider_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
