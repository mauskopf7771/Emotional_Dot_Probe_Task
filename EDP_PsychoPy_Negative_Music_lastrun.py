...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jackcrosby/Desktop/Robyn_PsychoPy/Robyn_PsychoPy_Negative_Music_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Please put on some headphones.\n\nYou are going to listen to a piece of music. Simply sit back and relax.\n\nWhen the music has finished you will do another set of trials similar to the ones you have previously completed.\n\nPress the ‘space’ bar to continue. ',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
key_resp_6.rt = []
_key_resp_6_allKeys = []
sound_1.setSound('NegativeMusic.aif', hamming=True)
